...
public class Client {
	...
	public static boolean runClient(String[] args, ParametersContainerE6 para) throws IOException {
		...
		// Used to transfer data to Python
		SocketHandler toPythonSocket = new SocketHandler(host, 3002, verbose);
		...
		do {
			...
			while (true) {
				...
				if (inMsg != null) {
					...
					toPythonSocket.send(inMsg + action.toString());
				} else {
				}
